...
CREATE TABLE IF NOT EXISTS `ops` (
  ...
  `Rss` varchar(150) NOT NULL DEFAULT '{"ps3":{"rss":{"ign":true,"gs":true,"up":true}},"xbox":{"rss":{"ign":true,"gs":true,"up":true}},"pc":{"rss":{"ign":true,"gs":true,"up":true}}}',
  PRIMARY KEY (`User`)
...
INSERT INTO `ops` (`User`, `Rss`) VALUES
(1, '{"ps3":{"rss":{"ign":true,"gs":true,"up":true}},"xbox":{"rss":{"ign":true,"gs":true,"up":true}},"pc":{"rss":{"ign":true,"gs":true,"up":true}}}');
